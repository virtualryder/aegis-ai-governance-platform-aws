...
- ◻ **One CISO caveat on HCLS:** PHI/PII masking and Bedrock+Guardrails are implemented and unit-tested but **not yet runtime-verified in the clean-account evidence path** — proving them live on AWS is the top next increment for the lead hero.
