...
Each of L1–L19 is closed with a test or an exact live assertion (L6 closed 2026-09-06; L14–L23 found by the full-portfolio gate on 2026-09-06 — attempts 2–7 — and closed on benefits main; attempt 5 is the from-zero re-run of the closed tree). The gate itself (`scripts/tier1_regate.py`) is now the
