# AWS Run-Cost Model — Aegis (platform)
...
below is for **the governed control plane** at pilot scale.*
...
with real figures from the Pricing Calculator**. Data class for this pack: cross-domain → PrivateLink per pack.
